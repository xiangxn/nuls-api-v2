...
var JsonRpcClient = exports.JsonRpcClient = /*#__PURE__*/function () {
   ...
   */
  return _createClass(JsonRpcClient, [{
    key: "delay",
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              if (!(_typeof(response.data.result) === "object" && "result" in response.data.result)) {
                _context.next = 14;
                break;
              }
            ...
            case 21:
              ...
              return _context.abrupt("return", {
                error: response.data.error.data.replace("Data error;", "").replace("contract error - ", "")
              });
            case 26:
              return _context.abrupt("return", {
                error: response.data.error.message.replace("Data error;", "").replace("contract error - ", "")
              });
            case 27:
              _context.next = 38;
              break;
            case 29:
              ...
              console.error("Max retries reached for method ".concat(method));
              throw _context.t0;
            case 35:
              console.warn("Retrying (".concat(attempt, "/").concat(this.maxRetries, ") method: ").concat(method, ", error: ").concat(_context.t0.message));
              _context.next = 38;
    ...
    key: "procResult",
    value: function procResult(result, value) {
      if ("result" in value) {
        if (_typeof(value.result) === "object" && "result" in value.result) {
        ...
        if ("data" in value.error && value.error.data) {
          result.push({
            error: value.error.data.replace("Data error;", "").replace("contract error - ", "")
          });
        } else {
          result.push({
            error: value.error.message.replace("Data error;", "").replace("contract error - ", "")
          });
        }
      } else {
        result.push(value.result);
    ...
    key: "batchCall",
    value: function () {
      var _batchCall = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(methods) {
        var _this = this;
        var params,
          payloads,
          i,
                ...
                return _regeneratorRuntime().wrap(function _loop$(_context2) {
                  while (1) switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      result = [];
                      _context2.next = 4;
                      return _this.client.post("/", payloads);
                    case 4:
                      ...
                      if (response.status == 200) {
                        if (response.data instanceof Array) {
                          response.data.forEach(function (value) {
                            _this.procResult(result, value);
                          });
                        } else {
                          _this.procResult(result, response.data);
                        }
                      }
                    ...
                    case 9:
                      ...
                      console.error("Max retries reached for methods ".concat(methods));
                      throw _context2.t0;
                    case 15:
                      console.warn("Retrying (".concat(attempt, "/").concat(_this.maxRetries, ") methods: ").concat(methods, ", error: ").concat(_context2.t0.message));
                      _context2.next = 18;
                      return _this.delay(_this.retryDelay);
                    case 18:
                    case "end":
      ...
      function batchCall(_x2) {
        return _batchCall.apply(this, arguments);
      }
      return batchCall;
    }()
  }]);
