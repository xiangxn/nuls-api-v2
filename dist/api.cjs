...
var NULSAPI = exports.NULSAPI = /*#__PURE__*/function () {
  ...
  return _createClass(NULSAPI, [{
    ...
    key: "getBlocks",
    value: function () {
      var _getBlocks = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee12(startBlock, endBlock) {
        var _this = this;
        var result, methods, params, i, res;
        return _regeneratorRuntime().wrap(function _callee12$(_context12) {
          while (1) switch (_context12.prev = _context12.next) {
            ...
            case 3:
              ...
              _context12.next = 8;
              return this.client.batchCall(methods, params);
            case 8:
              res = _context12.sent;
              res.forEach(function (value) {
                result.push(_this.getResult(value));
              });
              return _context12.abrupt("return", result);
            case 11:
            case "end":
    ...
    key: "getLatestHeight",
    value: function () {
      var _getLatestHeight = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee13() {
    ...
    key: "getCrossAssetInfo",
    value: function () {
      var _getCrossAssetInfo = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee14(assetChainId, assetId) {
        return _regeneratorRuntime().wrap(function _callee14$(_context14) {
          while (1) switch (_context14.prev = _context14.next) {
            case 0:
              _context14.t0 = this;
              _context14.next = 3;
              return this.client.call("getCrossAssetInfo", [assetChainId, assetId]);
            case 3:
              _context14.t1 = _context14.sent;
              return _context14.abrupt("return", _context14.t0.getResult.call(_context14.t0, _context14.t1));
            case 5:
            case "end":
      ...
      function getCrossAssetInfo(_x10, _x11) {
        return _getCrossAssetInfo.apply(this, arguments);
      }
      return getCrossAssetInfo;
    }()
  }, {
    key: "getTx",
    value: function () {
      var _getTx = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee15(txHash) {
    ...
    value: function () {
      var _getContractTxResult = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee16(txHash) {
        return _regeneratorRuntime().wrap(function _callee16$(_context16) {
          while (1) switch (_context16.prev = _context16.next) {
            ...
            case 3:
              ...
              return _context16.abrupt("return", _context16.t0.getResult.call(_context16.t0, _context16.t1, false));
            case 5:
            case "end":
      ...
      function getContractTxResult(_x13) {
    ...
    value: function () {
      var _getContractTxResultList = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee17(txHashs) {
        var hs;
      ...
      function getContractTxResultList(_x14) {
    ...
    key: "validateTx",
    value: (function () {
      var _validateTx = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee18(txHex) {
    ...
    key: "broadcastTx",
    value: function () {
      var _broadcastTx = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee19(txHex) {
    ...
    key: "sendCrossTx",
    value: function () {
      var _sendCrossTx = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee20(txHex) {
    ...
    key: "getContract",
    value: function () {
      var _getContract = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee21(contractAddress) {
    ...
    key: "invokeView",
    value: function () {
      var _invokeView = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee22(contractAddress, methodName) {
        var methodDesc,
          args,
          blockHeight,
          _args22 = arguments;
        return _regeneratorRuntime().wrap(function _callee22$(_context22) {
          while (1) switch (_context22.prev = _context22.next) {
            case 0:
              methodDesc = _args22.length > 2 && _args22[2] !== undefined ? _args22[2] : null;
              args = _args22.length > 3 && _args22[3] !== undefined ? _args22[3] : [];
              blockHeight = _args22.length > 4 && _args22[4] !== undefined ? _args22[4] : null;
              if (!blockHeight) {
                _context22.next = 19;
                break;
              }
            ...
            case 17:
              ...
              return _context22.abrupt("return", _context22.t2.getResult.call(_context22.t2, _context22.t3));
            case 19:
              _context22.t4 = this;
              _context22.next = 22;
            ...
            case 22:
              ...
              return _context22.abrupt("return", _context22.t4.getResult.call(_context22.t4, _context22.t5));
            case 24:
            case "end":
    ...
    value: function () {
      var _getContractMethodArgsTypes = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee23(contractAddress, methodName) {
        var methodDesc,
          _args23 = arguments;
        return _regeneratorRuntime().wrap(function _callee23$(_context23) {
          while (1) switch (_context23.prev = _context23.next) {
            case 0:
              methodDesc = _args23.length > 2 && _args23[2] !== undefined ? _args23[2] : null;
              _context23.t0 = this;
              _context23.next = 4;
      ...
      function getContractMethodArgsTypes(_x21, _x22) {
    ...
    value: function () {
      var _imputedContractCallGas = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee24(_ref2) {
      ...
      function imputedContractCallGas(_x23) {
    ...
    value: function () {
      var _contractCallOffline = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee25(_ref3) {
        ...
        return _regeneratorRuntime().wrap(function _callee25$(_context25) {
          while (1) switch (_context25.prev = _context25.next) {
            ...
            case 16:
              ...
              return _context25.abrupt("return", _context25.t0.getResult.call(_context25.t0, _context25.t1));
            case 18:
            case "end":
      ...
      function contractCallOffline(_x24) {
    ...
    value: function () {
      var _validateContractCall = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee26(_ref4) {
        ...
        return _regeneratorRuntime().wrap(function _callee26$(_context26) {
          while (1) switch (_context26.prev = _context26.next) {
            ...
            case 6:
              ...
              return _context26.abrupt("return", _context26.t0.getResult.call(_context26.t0, _context26.t1));
            case 8:
            case "end":
      ...
      function validateContractCall(_x25) {
    ...
    value: function () {
      var _updateMultyAsset = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee27(multyAssetArray) {
        ...
        return _regeneratorRuntime().wrap(function _callee27$(_context27) {
          while (1) switch (_context27.prev = _context27.next) {
            ...
            case 14:
              ...
              break;
            case 17:
              return _context27.abrupt("return", multyAssetArray);
            case 18:
            case "end":
      ...
      function updateMultyAsset(_x26) {
    ...
    value: function () {
      var _createContractTx = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee28(callInfo, remark, multyAssetArray, nulsValueToOthers) {
        var gasLimitTimes,
          gasMax,
          _yield$Promise$all3,
          _yield$Promise$all4,
        ...
        return _regeneratorRuntime().wrap(function _callee28$(_context28) {
          while (1) switch (_context28.prev = _context28.next) {
            case 0:
              gasLimitTimes = _args28.length > 4 && _args28[4] !== undefined ? _args28[4] : 1;
              gasMax = _args28.length > 5 && _args28[5] !== undefined ? _args28[5] : 0;
              _context28.next = 4;
            ...
            case 4:
              _yield$Promise$all3 = _context28.sent;
            ...
            case 21:
              ...
              return _context28.abrupt("return", tAssemble);
            case 25:
            case "end":
      ...
      function createContractTx(_x27, _x28, _x29, _x30) {
    ...
    key: "callContract",
    value: function () {
      var _callContract = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee29(callInfo, remark, multyAssetArray, nulsValueToOthers) {
        var gasLimitTimes,
          gasMax,
          pub,
          tAssemble,
        ...
        return _regeneratorRuntime().wrap(function _callee29$(_context29) {
          while (1) switch (_context29.prev = _context29.next) {
            case 0:
              gasLimitTimes = _args29.length > 4 && _args29[4] !== undefined ? _args29[4] : 1;
              gasMax = _args29.length > 5 && _args29[5] !== undefined ? _args29[5] : 0;
            ...
            case 14:
              ...
              return _context29.abrupt("return", result.hash);
            case 17:
      ...
      function callContract(_x31, _x32, _x33, _x34) {
    ...
    key: "transfer",
    value: function () {
      var _transfer = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee30(toAddress, value, remark, multyAssets) {
        ...
        return _regeneratorRuntime().wrap(function _callee30$(_context30) {
          while (1) switch (_context30.prev = _context30.next) {
            ...
            case 22:
              ...
              return _context30.abrupt("return", result.hash);
            case 25:
      ...
      function transfer(_x35, _x36, _x37, _x38) {
    ...
    key: "contract",
    value: function () {
      var _contract = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee31(address) {
        var contract;
        return _regeneratorRuntime().wrap(function _callee31$(_context31) {
          while (1) switch (_context31.prev = _context31.next) {
            ...
            case 3:
              return _context31.abrupt("return", contract);
            case 4:
            case "end":
    ...
    key: "waitingResult",
    value: (function () {
      var _waitingResult = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee32(txHash) {
        var timeout,
          result,
          second,
          _args32 = arguments;
        return _regeneratorRuntime().wrap(function _callee32$(_context32) {
          while (1) switch (_context32.prev = _context32.next) {
            case 0:
              timeout = _args32.length > 1 && _args32[1] !== undefined ? _args32[1] : 20;
              result = null;
              second = 0;
            case 3:
              if (!true) {
            ...
            case 13:
              ...
              break;
            case 16:
              return _context32.abrupt("break", 19);
            case 17:
              _context32.next = 3;
              break;
            case 19:
    ...
    key: "waitingTx",
    value: (function () {
      var _waitingTx = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee33(txHash) {
        var timeout,
          result,
          second,
          _args33 = arguments;
        return _regeneratorRuntime().wrap(function _callee33$(_context33) {
          while (1) switch (_context33.prev = _context33.next) {
            case 0:
              timeout = _args33.length > 1 && _args33[1] !== undefined ? _args33[1] : 20;
              result = null;
              second = 0;
            case 3:
              if (!true) {
            ...
            case 14:
              ...
              break;
            case 17:
              return _context33.abrupt("break", 20);
            case 18:
              _context33.next = 3;
              break;
            case 20:
